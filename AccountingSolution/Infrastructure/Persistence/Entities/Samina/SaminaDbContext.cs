...
public partial class SaminaDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<BranchUser>(entity =>
        {
            ...
            entity.HasOne(d => d.IdNavigation).WithOne(p => p.BranchUser)
                .HasForeignKey<BranchUser>(d => d.Id)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_BranchUser_Roles");
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.Property(e => e.Email)
                .HasMaxLength(30)
                .HasComment("نام کاربری - ایمیل کاربر");
            entity.Property(e => e.Fname)
                .HasMaxLength(20)
