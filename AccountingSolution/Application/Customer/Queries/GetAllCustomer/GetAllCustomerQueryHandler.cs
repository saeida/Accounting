...
{
    public class GetAllCustomerQueryHandler : IRequestHandler<GetAllCustomerQuery, List<CustomerModel>>
    {
        private readonly ICustomerQueryRepository _customerQueryRepository;
        private readonly IHttpContextAccessor _httpContextAccessor;
        public GetAllCustomerQueryHandler(ICustomerQueryRepository customerQueryRepository, IHttpContextAccessor httpContextAccessor)
        {
